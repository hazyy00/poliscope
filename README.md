...
| `/bills/[id]` AI 요약 | 🚧 Coming Soon | Claude AI 법안 요약. 한 단락 핵심 요약 + 직장인·자영업자·학생 페르소나별 해석 |
| `/ai-guide` | 🚧 Coming Soon | AI 투명성 페이지. 요약 기준·한계·오류 신고 방법 공개 |
| `/ai-picks` | 🚧 Coming Soon | AI 큐레이션. 중요 법안 선별 심층 분석, 본회의 표결 시점 이벤트 기반 발행 |
